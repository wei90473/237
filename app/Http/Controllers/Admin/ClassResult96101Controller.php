...
class ClassResult96101Controller extends Controller
{
    public function __construct(User_groupService $user_groupService)
    {
        ...
        $this->middleware(function($request, $next){
            ...
            if(in_array('class_result_96_101', $user_group_auth)){
                return $next($request);
            }else{
    ...
    {
        return view('admin/class_result_96_101/list');
    }

    /*
    年度各班期訓練成效評估統計表 CSDIR5032
    參考Tables:
    使用範本:L14A.xlsx, L14B.xlsx (區別是有無行政服務欄位項目)
    */
    /**
     * 列印檔案
     *
    ...
    public function export(Request $request)
    {
        ...
        $RptBasic->exportfile($objPHPExcel,"2",$request->input('doctype'),"年度各班期訓練成效評估統計表(96)");
        //$obj: entity of file
