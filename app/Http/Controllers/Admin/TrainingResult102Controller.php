...
class TrainingResult102Controller extends Controller
{
    public function __construct(User_groupService $user_groupService)
    {
        ...
        $this->middleware(function($request, $next){
            ...
            if(in_array('training_result_102', $user_group_auth)){
                return $next($request);
            }else{
    ...
    {
        //return view('admin/training_result_102/list');
        $classArr = $this->getclass();
        $result = '';
        return view('admin/training_result_102/list', compact('classArr', 'result'));
    }
    ...
    public function getclass() {
            $sql = "SELECT DISTINCT t53tb.class, t01tb.name
                     ...
                     WHERE t53tb.times<>'' AND SUBSTRING(t53tb.class,1,3) between '102' and '103'
    ...
    */
    ...
    $RptBasic = new \App\Rptlib\RptBasic();
    $RptBasic->exportfile($objPHPExcel,"3",$request->input('doctype'),"訓練成效評估結果統計圖表(102)");
    //$obj: entity of file
