...
class TrainingEvaluation105Controller extends Controller
{
    public function __construct(User_groupService $user_groupService)
    {
        ...
        $this->middleware(function($request, $next){
            ...
            if(in_array('training_evaluation_105', $user_group_auth)){
                return $next($request);
            }else{
    ...
    public function index(Request $request)
    {
        ...
        $result = '';
        return view('admin/training_evaluation_105/list', compact('classArr', 'result'));
    }
    ...
    */
    ...
    public function export(Request $request)
    {
        ...
        // 讀檔案
        $templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('../example/'.iconv('UTF-8', 'BIG5', 'L1').'.docx');
        ...
        $sql = "SELECT IFNULL(m01.cname,'') as cname,
                       CONCAT('(',IFNULL(t06.name,''),')') as classname,
                       t54.course,
                       t54.idno
        ...
        $RptBasic = new \App\Rptlib\RptBasic();
        $RptBasic->exportfile($templateProcessor,"1",$request->input('doctype'),"訓練成效評估表(105)");
        //$obj: entity of file
