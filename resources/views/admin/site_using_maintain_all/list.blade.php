...
@section('content')
    ...
    <?php $_menu = 'site_using_maintain_all';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">各場地借用情形及維護費收入統計表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">各場地借用情形及維護費收入統計表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>各場地借用情形及維護費收入統計表</h3>
                        </div>

                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                <form method="post" action="/admin/site_using_maintain_all/export" id="search_form">
                                        {{ csrf_field() }}
                                                <!--  variable declare  --> 
