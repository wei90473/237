...
@section('content')
    ...
    <?php $_menu = 'manage_monthly_conference';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">場地使用管理月報表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">場地使用管理月報表</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="/admin/manage_monthly_conference/export" id="search_form">
                        {{ csrf_field() }}
