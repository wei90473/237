...
@section('content')
    ...
    <?php $_menu = 'teaching_material_statistics_rpt';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="/admin/teaching_material_statistics_rpt/export" id="search_form">
                        {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group row">
                                            <label class="col-2">支付月份(YYYMM)<span class="text-danger">*</span></label>
