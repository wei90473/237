    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="col-md-10 offset-md-1 p-0">
                <div class="card">
                    <div class="card-header"><h3 class="card-title">需求分配維護(2)</h3></div>
                    <div class="card-body pt-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control input-max" value="{{ $data->class }} {{ $data->name }}" disabled>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive input-max">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody id="data_content">
                                            ...
                                            <tr>
                                                <td>合計</td>
                                                <td>總分配人數：<input type="text" class="form-control" id="totalPeople" name="total_applycnt" value={{$data->quotatot}} readonly></td>
                                            ...
                                            @foreach($list2 as $demandQty)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control checkcnt" maxlength="5" autocomplete="off" name="checkcnt[]"  value="{{ $demandQty->quota or 0 }}" required onchange="countTotal()">
                                                    </td>
            ...
            <tr>
                <td width="60%">
                    <select name="organ[]" class="autoselect2 form-control organ" required>
                        ...
                        @foreach($institutionList as $va)
                            <option value="{{ $va->enrollorg }}">{{ $va->enrollorg }} {{ $va->enrollname }}</option>
                        @endforeach
                    </select>
                </td>
                <td>
...
@section('js')
    <script>
        ...
        function countTotal() {
            ...
            $('#total_applycnt').val(qtyRequireTotal);
