...
@section('content')
    ...
    <?php $_menu = 'daily_distribution_conference';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">會議場地每日分配表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">會議場地每日分配表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>會議場地每日分配表</h3>
                        </div>
                        <div class="card-body">
                            <form id="exportFile" method="post" id="search_form" action="/admin/daily_distribution_conference/export" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <?php $sdatetw =''; $edatetw =''; ?>
