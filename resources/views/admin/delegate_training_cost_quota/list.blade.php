...
@section('content')
    ...
    <?php $_menu = 'delegate_training_cost_quota';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">委訓經費各單位分配額度表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">委訓經費各單位分配額度表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>委訓經費各單位分配額度表</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form method="get" action="/admin/delegate_training_cost_quota/export" id="search_form">
...
<script>
    function getTerms()	{
        $.ajax({
            ...
            dataType: "html",
            url:"/admin/delegate_training_cost_quota/getTerms",
