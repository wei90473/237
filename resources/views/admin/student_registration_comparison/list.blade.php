...
@section('content')
    ...
    <?php $_menu = 'student_registration_comparison';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">名額分配及需求填報對照表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">名額分配及需求填報對照表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>名額分配及需求填報對照表</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="float-left search-float col-12">
                                        <form id="exportFile" method="post" id="search_form" action="/admin/student_registration_comparison/export" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                            <!-- 班別 -->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-5">
                                                    <div class="input-group bootstrap-touchspin number_box">
                                                        <select id="startterm" name="startterm" class="select2 form-control select2-single input-max" required>
                                                        <?php foreach ($termArr as $key => $va) { ?>
                                                            <option value='<?=$va->term?>'><?=$va->term?></option>
                                                        <?php } ?>
                                                        </select>
                                                        <label align="center" class="col-sm-1">~</label>
                                                        <select id="endterm" name="endterm" class="select2 form-control select2-single input-max" required>
                                                        <?php foreach ($termArr as $key => $va) { ?>
                                                            <option value='<?=$va->term?>'><?=$va->term?></option>
                                                        <?php } ?>
                                                        </select>
...
<script>
    ...
    function getTerms()	{
        $.ajax({
            ...
            dataType: "html",
            url:"/admin/student_registration_comparison/getTerms",
