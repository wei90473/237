...
@section('content')
    ...
    <?php $_menu = 'training_period_list';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">訓期一覽表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">訓期一覽表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>訓期一覽表</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <form method="get" action="/admin/training_period_list/export" id="search_form">
                                                {{ csrf_field() }}
