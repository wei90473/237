    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">國定假日</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">國定假日列表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>國定假日</h3>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <th>假日名稱<i class="fa fa-sort" data-toggle="sort" data-sort-field="holiday"></i></th>
                                                <th>日期<i class="fa fa-sort" data-toggle="sort" data-sort-field="date"></i></th>
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="/admin/holiday/{{ $va->date }}/edit" data-placement="top" data-toggle="tooltip" data-original-title="修改">
                                                    ...
                                                    <!-- 刪除 -->
                                                    <td class="text-center">
                                                        <span onclick="$('#del_form').attr('action', '/admin/holiday/{{ $va->date }}');" data-toggle="modal" data-target="#del_modol" >
