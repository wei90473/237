                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form id="exportFile" method="post" id="search_form" action="/admin/student_grade_rpt/export" enctype="multipart/form-data">
                                {{ csrf_field() }}
...
<script>
    ...
    function getTerms()	{
        $.ajax({
            ...
            dataType: "html",
            url:"/admin/student_grade_rpt/getTerms",
