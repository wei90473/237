...
@section('content')
    ...
    <?php $_menu = 'interbank_remittance_form';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">郵政跨行匯款申請書</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">郵政跨行匯款申請書</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>郵政跨行匯款申請書</h3>
                        </div>

                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                <form id="exportFile" method="post" id="search_form" action="/admin/interbank_remittance_form/export" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group row align-items-center">
                                            <!--  datepicker -->
                                            <label class="col-sm-1">轉存日期</label>
                                            <div class="col-3">
