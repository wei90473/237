                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <!-- 搜尋 -->
                                    <div class="float-left search-float" style="margin-bottom: 10px;margin-bottom: 10px;min-width: 1000px;">
                                        <form method="get" id="search_form">										
                                            ...
                                            <a href="/admin/digital/class_list"><button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0">重設條件</button></a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered mb-0">
                                            <thead>
                                            <tr>
                                                <th width="200" class="text-center">功能</th>
                                            ...
                                            @foreach($data as $t04tb)
                                                <tr>
                                                    <td class="text-center">
                                                        <a href="/admin/digital/class_setting/{{ $t04tb->class }}/{{ $t04tb->term }}">
                                                            <button class="btn btn-primary btn-sm mb-3 mb-md-0">編輯</button>
                                                        </a>

                                                        <a href="/admin/digital/student/{{ $t04tb->class }}/{{ $t04tb->term }}">
                                                            <button class="btn btn-primary btn-sm mb-3 mb-md-0">學員明細</button>
                                                        </a>
                                                    </td>
                                                    <td class="text-center">
                                                    @if ($t04tb->t01tb)
