    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">中文最新消息維護</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">中文最新消息維護列表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>中文最新消息維護</h3>
                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2" name="type">
                                                        ...
                                                        @foreach(config('app.news_tw_type') as $key => $va)
                                                            <option value="{{ $key }}" {{ $queryData['type'] == $key? 'selected' : '' }}>{{ $va }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ ($now >= $va->sdate && $now <= $va->edate)? '★' : '' }}</td>
                                                    <td>{{ config('app.news_tw_type.'.$va->type) }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="/admin/news_tw/{{ $va->serno }}/edit" data-placement="top" data-toggle="tooltip" data-original-title="修改">
                                                    ...
                                                    <!-- 刪除 -->
                                                    <td class="text-center">
                                                        <span onclick="$('#del_form').attr('action', '/admin/news_tw/{{ $va->serno }}');" data-toggle="modal" data-target="#del_modol" >
