                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <a href="/admin/teacher_reception/{{ $va->t09tb_id }}_{{ $va->class_weeks_id }}_room_{{ $queryData['date'] }}/edit1" data-placement="top" data-toggle="tooltip" data-original-title="修改">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                </td>
                                                <td>{{ $va->name }}</td>
                                                <td>
                                                    <?php if(!empty($va->time)){?>
