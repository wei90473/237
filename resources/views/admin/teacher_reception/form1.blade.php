                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div id="after_day2" class="col-sm-11">
                                ...
                                <?php } ?>
                            <?php } ?>
                            <label class="col-sm-4 control-label text-md-right pt-2"><font color="#FF0000">*當天晚上有住送出後 住宿別會自動增加隔天早上</font></label>
                            <label class="col-sm-8 control-label text-md-right pt-2"></label>
                            <label class="col-sm-4 control-label text-md-right pt-2"><font color="#FF0000">*每次修改住宿日期後 請重新確認或修改用餐資料</font></label>
                            <label class="col-sm-8 control-label text-md-right pt-2"></label>
                        </div>

                        <div class="form-group row">
                            <label class="col-sm-1 control-label text-md-right pt-2">寢室：</label>
                            <div class="input-group  col-2">
                                <select id="room_no" name="room_no" class="select2 form-control select2-single input-max" >
                                    <option value="" >請選擇</option>
                                    <?php foreach($RoomNumber as $room_row){ ?>
                                        <option value="{{ $room_row['room_number'] }}" {{ old('room_no', (isset($TeacherByWeek_data['room_no']))? $TeacherByWeek_data['room_no'] : 1) == $room_row['room_number']? 'selected' : '' }}>{{ $room_row['room_number'] }}</option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
