    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">講座接待管理</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">講座接待管理列表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>講座接待管理</h3>
                        </div>
...
<!-- 進階/簡易搜尋結束 -->
                                            ...
                                            <div class="float-left">
                                                ...
                                                <a href="/admin/teacher_reception/car_detail">
                                                    <button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0">計程車安排</button>
                                                </a>
                                                <a href="/admin/teacher_reception/room_detail">
                                                    <button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0">寢室安排</button>
                                                </a>
                                                <a href="/admin/teacher_reception/food_detail">
                                                    <button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0">用餐安排</button>
                                                </a>
                                            </div>
                                        </form>
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="/admin/teacher_reception/detail?class={{ $va->class }}&term={{ $va->term }}&sdate={{ $va->sdate }}" data-placement="top" data-toggle="tooltip" data-original-title="檢視">
                                                            檢視
                                                        </a>
                                                    </td>
