                                            ...
                                            @foreach($teacher_list as $row)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="/admin/teacher_reception/{{ $row['id'] }}_{{ $class_data['class_weeks_id'] }}/edit1" data-placement="top" data-toggle="tooltip" data-original-title="修改">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <span onclick="$('#confirm_form').attr('action', '/admin/teacher_reception/changeConfirm/<?=$row['id'];?>');" data-toggle="modal" data-target="#confirm_modol">
                                                        <input type="checkbox" id="confirm2" name="confirm2" style="min-width:20px; margin-left:5px;" <?=($row['confirm2']=='Y')?'checked':'';?> value="" >
                                                        </span>
                                                    </td>
                                                    <td>{{ $row['cname'] }}</td>
                                                    <td>
            ...
            <div class="modal-content p-0 b-0">
                <div class="card mb-0">
                    <div class="card-header bg-warning">
                        <h3 class="card-title float-left text-white">需求確認</h3>
