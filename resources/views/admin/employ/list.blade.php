...
<!-- 進階/簡易搜尋結束 -->
                                            ...
                                            <div class="float-left">
                                                ...
                                                <a href="/admin/employ/payroll">
                                                    <button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0">講課酬勞查詢</button>
                                                </a>
                                            </div>
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="/admin/employ/detail?class={{ $va->class }}&term={{ $va->term }}" data-placement="top" data-toggle="tooltip" data-original-title="修改">
