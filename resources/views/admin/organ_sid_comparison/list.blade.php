...
@section('content')
    ...
    <?php $_menu = 'organ_sid_comparison';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">學員服務機關與學號對照表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">學員服務機關與學號對照表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>學員服務機關與學號對照表</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form id="exportFile" method="post" id="search_form" action="/admin/organ_sid_comparison/export" enctype="multipart/form-data">
                                {{ csrf_field() }}
...
<script>
    ...
    function getTerms()	{
        $.ajax({
            ...
            dataType: "html",
            url:"/admin/organ_sid_comparison/getTerms",
