    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">早餐及住宿名單處理</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">早餐及住宿名單處理列表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>早餐及住宿名單處理</h3>
                        </div>
                                            ...
                                            <div class="pull-left mobile-100 mr-1 mb-3">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select2" id="type" name="type">
                                                        @foreach(config('app.stay_list_type') as $key => $va)
                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $va->cname }}</td>
                                                    <td>{{ config('app.stay_list_type.'.$va->type) }}</td>

                                                    <!-- 修改 -->
                                                    <td class="text-center">
                                                        <a href="/admin/stay_list/{{ $va->serno }}/edit" data-placement="top" data-toggle="tooltip" data-original-title="修改">
                                                    ...
                                                    <!-- 刪除 -->
                                                    <td class="text-center">
                                                        <span onclick="$('#del_form').attr('action', '/admin/stay_list/{{ $va->serno }}');" data-toggle="modal" data-target="#del_modol" >
