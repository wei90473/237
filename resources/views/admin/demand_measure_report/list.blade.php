...
@section('content')
    ...
    <?php $_menu = 'demand_measure_report';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">需求調查表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">需求調查表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>需求調查表</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <!-- 搜尋 -->
                                        ...
                                        <form method="post" id="search_form" action="/admin/demand_measure_report/export" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                            <!-- 年度 -->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group bootstrap-touchspin number_box">
                                                        <input type="text" class="form-control input-max" id="times" name="times" value="" autocomplete="off" required onclick="chooseTimes();" onkeyup="this.value=this.value.replace(/[^\d]/g,'');">
                                                    ...
                                                    <!-- <div class="input-group bootstrap-touchspin number_box">
                                                        ...
                                                        <option value="0">請選擇</option>
                                                            {{-- @foreach($timeslist as $va)
                                                                <option value="{{ $va->times }}">{{ $va->times }}</option>
                                                            @endforeach --}}
                                                        </select>
                                                    </div> -->
                                                </div>
...
if("<?php echo ($result); ?>" != ""){
    ...
    function getTimes()
    {
        ...
        $.ajax({
            ...
            dataType: "html",
            url: '/admin/demand_measure_report/gettime',
            data: {yerly: $('#yerly').val()},
            success: function(response){
                console.log(response);
                let dataArr =JSON.parse(response);
                // let tempHTML = "<option value='0'>請選擇</option> ";
                let tempHTML = "";
