...
<!-- 進階/簡易搜尋開始 -->
                                            ...
                                            <div class="float-md mobile-100 row mr-1 mb-3 input-daterange  jDaterange">
                                                <div class="input-group col-6">
                                                    <div class="input-group-prepend">
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="/admin/waiting/detail?class={{ $va->class }}&term={{ $va->term }}" data-placement="top" data-toggle="tooltip" data-original-title="修改">
