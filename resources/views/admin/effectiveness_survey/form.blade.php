...
@section('content')
                    ...
                    <div class="card-body pt-4">
                        ...
                        @if(isset($data))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control input-max" id="times" maxlength='1' name="times" placeholder="請輸入第幾次調查"  autocomplete="off" maxlength="255" required>
                                </div>
                            </div>
                           ...
                           @else
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 control-label text-md-right pt-2">第幾次調查<span class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control input-max" id="times" name="times" placeholder="請輸入第幾次調查" value="{{ old('times', (isset($data['times']))? $data['times']: '') }}" autocomplete="off" maxlength="255" required {{ (isset($data))? 'readonly' : ''}}>
                                </div>
                            </div>
                            @endif
                        ...
                        <!-- 填報開始日期 -->
                        <div class="form-group row">
                            <label class="col-sm-2 control-label text-md-right pt-2">填表開始日期</label>
                            <div class="col-sm-10">
                        ...
                        <!-- 填報結束日期 --><!--換課程/講座-->
                        <div class="form-group row">
                            <label class="col-sm-2 control-label text-md-right pt-2">填表結束日期</label>
                            <div class="col-sm-10">
                                <div class="input-group roc-date input-max">
                                    <div class="input-group col-sm-10">                                        
                            ...
                            @if(!empty($data))
                            <div class="col-sm-2 text-md-right pt-5" >
                                <a href="/admin/effectiveness_survey/change/{{serialize($data)}}/edit" data-placement="top" data-toggle="tooltip" data-original-title="更換">
                                    <i class="fa fa-pencil"></i>換【課程/講座】
                                </a>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <?php
                            $arr=['class'=>$data['class'],
                                  'term'=>$data['term']];
                        ?>
                        <a href="/admin/effectiveness_survey/{{serialize($arr)}}/detail">
    ...
    <?php if(!isset($create)){ ?>
        @include('admin/layouts/list/del_model_survey')
    <?php }?>
...
<script>
    function submitform(){
        ...
        /*if(str=="edit"){
            if($(".item_check input[type=\"checkbox\"]").length==0){
                alert("至少要選擇一門課");
                return;
            }
        }else{
            if($("#course_div input:checkbox:checked").length==0){
                alert("至少要選擇一門課");
                return;
            }
        }*/
