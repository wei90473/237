...
@section('content')
    ...
    <?php $_menu = 'application_stickynote';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">申請表及黏存單</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">申請表及黏存單</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>申請表及黏存單</h3>
                        </div>
                        ...
                        <form id="exportFile" method="post" id="search_form" action="/admin/application_stickynote/export" enctype="multipart/form-data">                        
                                {{ csrf_field() }}
                                <div id="divarea"  class="form-group row justify-content-center align-items-center">
                                        ...
                                        <div class="form-group row justify-content-center align-items-center" id="datepicker">
                                            ...
                                            <input type="text" class="form-control  col-md-6 " value="{{$weekpicker}}" id="weekpicker" placeholder="請選擇要查詢的星期" readonly name="weekpicker"  min="1" autocomplete="off" required>
                                        </div>
                                        ...
                                        <div id="dvdoctype" class="form-group row  align-items-center">
                                            <label class="col-5 text-right">請選檔案格式：</label>
