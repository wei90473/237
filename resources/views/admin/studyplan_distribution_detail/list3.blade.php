                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>名額分配明細表V3</h3>
                        </div>
                                    ...
                                    <div class="float-left search-float col-12">
                                        ...
                                        {{ csrf_field() }}
                                            ...
                                            <div align="center">
                                                ...
                                                <label class="control-label text-md-right pt-2" style="font-size: 12px;">輸入匯出條件(二選一)      2132312313213</label>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script>
    ...
    function submitSearch() {
        // if((($("#yerly").val() == "" || $("#times").val() == "") && $("#classes").val() == "") || ($("#yerly").val() != "" && $("#times").val() != "" && $("#classes").val() != "")) {
        //     alert("匯出條件(二選一)");
        //     return;
        //}
