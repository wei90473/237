...
@section('content')
    ...
    <?php $_menu = 'food_expense_writeoff';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">伙食費核銷明細表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">伙食費核銷明細表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>伙食費核銷明細表</h3>
                        </div>

                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <form method="post" action="/admin/food_expense_writeoff/export" id="search_form">
                                        {{ csrf_field() }}
   ...
   if("<?php echo ($result); ?>" != ""){
    ...
    function getTerms()	{
        $.ajax({
            ...
            dataType: "html",
            url:"/admin/food_expense_writeoff/getTerms",
