                                                    ...
                                                    <div class="halfArea" style="flex:1;height:300px;max-width:400px;overflow:auto;">
                                                        ...
                                                        <div class="item_con item_uncheck" style="visibility: hidden;"></div>
                                                            ...
                                                            <div class="item_con item_uncheck">
                                                                <input id="course{{ $key }}" name="course[]" value="{{$not_select_temp['site']}}"  type="checkbox" hidden>
                                                                <label onclick="selectItem(this)">
                                                                    {{$not_select_temp['name']}}
                                                                </label>
                                                            </div>
                                                            <?php $key ++;?>
                                                            @endforeach
                                                        ...
                                                        <div class="halfArea" style="flex:1;height:300px;max-width:400px;overflow:auto;">
                                                            ...
                                                            <div class="item_con item_check">
                                                                <input id="course{{ $key }}" name="course[]" value="{{$select_temp['site']}}" type="checkbox" checked hidden>
                                                                <label onclick="selectItem(this)">
                                                                    {{$select_temp['name']}}
                                                                </label>
                                                            </div>
