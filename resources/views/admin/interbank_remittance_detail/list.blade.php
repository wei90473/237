...
@section('content')
    ...
    <?php $_menu = 'interbank_remittance_detail';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">跨行匯款明細表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">跨行匯款明細表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>跨行匯款明細表</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form id="exportFile" method="post" id="search_form" action="/admin/interbank_remittance_detail/export" enctype="multipart/form-data">
                                {{ csrf_field() }}
