...
@section('content')
    ...
    <?php $_menu = 'student_registration';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">學員報名表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">學員報名表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>學員報名表</h3>
                        </div>

                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <form method="post" action="/admin/student_registration/export" id="search_form">
                                        {{ csrf_field() }}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="input-group bootstrap-touchspin number_box">
                                                            <select id="classes" name="class" class="select2 form-control select2-single input-max" onchange="getTerms();">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="input-group bootstrap-touchspin number_box">
                                                            <select id="terms" name="term" class="select2 form-control select2-single input-max" >
   ...
   if("<?php echo ($result); ?>" != ""){
    ...
    function getTerms()	{
        $.ajax({
            ...
            dataType: "html",
            url:"/admin/student_registration/getTerms",
