...
@section('content')
    ...
    <?php $_menu = 'student_mail_nametape';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">學員郵寄名條</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">學員郵寄名條</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>學員郵寄名條</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form id="exportFile" method="post" id="search_form" action="/admin/student_mail_nametape/export" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div id="dvtype" class="form-group row justify-content-left align-items-center">
                                        ...
                                        <label class="col-1 text-left " id="label1">機關</label>
                                        <input class="mb-2 float-right" type="radio" id="type2" name="type" value="2" >
                                        <label class="col-1 text-left" id="label2" >住家</label>    
                                        <input class="mb-2 float-right" type="radio" id="type3" name="type" value="3"" >
                                        <label class="col-1 text-left" id="label3" >郵寄</label>    
                                    </div>
...
<script>
    ...
    function getTerms()	{
        $.ajax({
            ...
            dataType: "html",
            url:"/admin/student_mail_nametape/getTerms",
