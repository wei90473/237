...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row pc_show">
            <div class="col-sm-12">
                <h4 class="pull-left page-title">場地借用現況查詢﹣可借用寢室床位</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="/admin">首頁</a></li>
                    <li class="active">場地借用現況查詢﹣可借用寢室床位</li>
                </ol>
            </div>
        </div>
        <!-- 提示訊息 -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-list pr-2"></i>場地借用現況查詢﹣可借用寢室床位</h3>
                    </div>
                    <div class="card-body">
                    	<div class="row">
