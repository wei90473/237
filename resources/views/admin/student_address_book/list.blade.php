...
@section('content')
    ...
    <?php $_menu = 'student_address_book';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">學員通訊錄</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">學員通訊錄</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>學員通訊錄</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form id="exportFile" method="post" id="search_form" action="/admin/student_address_book/export" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div id="dvtype" class="form-group row justify-content-left align-items-center">
                                        ...
                                        <label class="col-1 text-left " id="label1">簡式</label>
                                        <input class="mb-2 float-right" type="radio" id="type2" name="type" value="2" >
                                        <label class="col-1 text-left" id="label2" >詳細</label>    
                                    </div>
...
<script>
    ...
    function getTerms()	{
        $.ajax({
            ...
            dataType: "html",
            url:"/admin/student_address_book/getTerms",
