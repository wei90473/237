    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">年度各班期訓練成效評估統計表(96)</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">年度各班期訓練成效評估統計表(96)</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="/admin/class_result_96_101/export" id="search_form">
                        {{ csrf_field() }}
