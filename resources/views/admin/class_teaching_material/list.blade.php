...
@section('content')
    ...
    <?php $_menu = 'class_teaching_material';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">班別教材一覽表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">班別教材一覽表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>班別教材一覽表</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="float-left search-float col-12">
                                        <form method="post" id="search_form" action="/admin/class_teaching_material/export" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                            <!-- 班別 -->
...
<script>
    ...
    function getTermByOP()
    {
        $.ajax({
            ...
            dataType: "html",
            url: '/admin/class_teaching_material/getTermByOP',
