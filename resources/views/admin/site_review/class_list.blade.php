            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="float-left search-float" style="margin-bottom: 10px;min-width:1000px;">
                                        <form method="get" id="search_form">										
                                            ...
                                            <a href="/admin/site_review/class_list"><button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0">重設條件</button></a>
                                        </form>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered mb-0">
                                            ...
                                            @foreach($data as $t04tb)
                                                <tr>
                                                    <td><a href="/admin/site_review/{{ $t04tb->class }}/{{ $t04tb->term }}"><button class="btn btn-primary btn-sm mb-3 mb-md-0">編輯</button><a/></td>
                                                    ...
                                                    <td class="text-center">{{ (empty($t04tb->t39tbNum)) ? 0 : $t04tb->t39tbNum }} </td>
                                                    <td>
                                                    @if ($t04tb->t01tb)
                                                        @if (!empty(config('app.branch')[$t04tb->t01tb->branch]))
                        ...
                        @if($data)
                        <!-- 列表頁尾 -->
                        @include('admin/layouts/list/card_footer')
                        @endif
                    </div>
                </div>
            </div>
