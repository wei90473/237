...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row pc_show">
            <div class="col-sm-12">
                <h4 class="pull-left page-title">寢室安排</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="/admin">首頁</a></li>
                    <li class="active">寢室安排</li>
                </ol>
            </div>
        </div>
        <!-- 提示訊息 -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-list pr-2"></i>寢室安排</h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="search-float" style="width:100%;">
                                    {{ Form::open(["id" => "search_form", "method" => "put", "url" => "admin/roomset/batchUpdateBedInfo"]) }}
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <div class="input-group">
                                                ...
                                                <p class="form-control">{{ !empty($data[0]['staystartdate'])?$data[0]['staystartdate']:$data[0]['sdate'] }}{{$data[0]['staystarttime']}}</p>
                                                <input type="hidden" id='staystartdate' name='staystartdate' value="{{ !empty($data[0]['staystartdate'])?$data[0]['staystartdate']:$data[0]['sdate'] }}">
                                        ...
                                        <div class="form-group col-md-3">
                                            <div class="input-group">
                                                ...
                                                <p class="form-control">{{ !empty($data[0]['stayenddate'])?$data[0]['stayenddate']:$data[0]['edate'] }}{{$data[0]['stayendtime']}}</p>
                                                <input type="hidden" id='stayenddate' name='stayenddate' value="{{ !empty($data[0]['stayenddate'])?$data[0]['stayenddate']:$data[0]['edate'] }}">
                                ...
                                {{ Form::open(["id" => "search_form", "method" => "put", "url" => "admin/roomset/updateBedset"]) }}
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <input name="bedno_{{ $text['no'] }}" readonly="readonly" value="{{ $text['bedno'] }}">
                                                    <span class="input-group-addon" style="cursor: pointer;" onclick="selectEmptyBed('{{ $text['no'] }}')">...</span>
                                                </td>
                                                <td class="text-center">
                                                     <input name="bedname_{{ $text['no'] }}" readonly="readonly" value="{{ $room_alias }}">
                                                </td>
                                                <input type="hidden" name="floorno_{{ $text['no'] }}" value="{{ $text['floorno'] }}">
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
...
function clearValue()
{
    $("input[name='bedno_" + studentNo + "']").val('');
    $("input[name='bedname_" + studentNo + "']").val('');
    $("input[name='floorno_" + studentNo + "']").val('');
}
