...
@section('content')
    ...
    <?php $_menu = 'stay_distribution_byclass';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">學員住宿分配一覽表(分班)</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">學員住宿分配一覽表(分班)</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>學員住宿分配一覽表(分班)</h3>
                        </div>

                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                <form method="post" action="/admin/stay_distribution_byclass/export" id="search_form">
                                        {{ csrf_field() }}
                                                <!--  variable declare  -->
                                                <?php $sdatetw =''; $edatetw =''; ?>
