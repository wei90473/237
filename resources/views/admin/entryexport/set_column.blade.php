                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <form method="post" action="admin/entryexport/select_class">  
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">                                      
                                        <div class="col-md-10 offset-md-1 p-0">
                                            <!-- 可選取欄位 -->
                                            <span>可選取欄位</span>
                                            <span style="margin-left:30%">已選取欄位</span>
                                            <div class="form-group row">
                                                <div class="col-md-10" id="course_div" style='display: flex;'>
                                                    ...
                                                    <div class="halfArea" style="flex:1;height:300px;max-width:400px;overflow:auto;">
                                                        ...
                                                        <div class="item_con item_uncheck" style="visibility: hidden;"></div>
                                                            @foreach($not_select as $not_select_temp)
                                                            <div class="item_con item_uncheck">
                                                                <input id="course{{ $key }}" name="course[]" value="{{$not_select_temp['class']}}_{{$not_select_temp['term']}}"  type="checkbox" hidden>
                                                                <label onclick="selectItem(this)">
                                                                    {{$not_select_temp['class']}}{{$not_select_temp['term']}}{{$not_select_temp['name']}}
                                                                </label>
                                                            </div>
                                                            <?php $key ++;?>
                                                            @endforeach
                                                        ...
                                                        <div class="halfArea" style="flex:1;height:300px;max-width:400px;overflow:auto;">
                                                            ...
                                                            @foreach($select as $select_temp)
                                                            <div class="item_con item_check">
                                                                <input id="course{{ $key }}" name="course[]" value="{{$select_temp['class']}}_{{$select_temp['term']}}" type="checkbox" checked hidden>
                                                                <label onclick="selectItem(this)">
                                                                    {{$select_temp['class']}} {{$select_temp['term']}} {{$select_temp['name']}}
                                                                </label>
                                                            </div>
                                                            <?php $key ++;?>
                                                            @endforeach
                                                ...
                                                <div class="col-md-12">
                                                    <label>匯出檔案格式:</label>
                                                    <input type="radio" name="export" value="excel" checked>EXCEL
                                                    <input type="radio" name="export" value="txt">文字檔
                                                </div>
                                                <?php }?>
                                            </div>
