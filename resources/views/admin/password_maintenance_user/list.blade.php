...
@section('content')
    ...
    <?php $_menu = 'password_maintenance_user';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">個人密碼維護</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">個人密碼維護列表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>個人密碼維護</h3>
                        </div>
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <tr class="{{ ($va->m17status == 'N')? 'bg-danger text-white' : '' }}">
                                                    ...
                                                    {{--<td class="text-center">--}}
                                                        ...
                                                        {{--</a>--}}
                                                    {{--</td>--}}
                                                    <td class="text-center"><button type="button" class="btn btn-primary waves-effect waves-light m-b-5" data-toggle="modal" data-target="#modol_1" onclick="$('#model_1_userid').val('{{ $va->userid }}');$('#model_1_userorg').val('{{ $va->enrollorg }}');">使用設定</button></td>
                                                    <td class="text-center"><button type="button" class="btn btn-success waves-effect waves-light m-b-5" data-toggle="modal" data-target="#modol_2" onclick="$('#model_2_userid').val('{{ $va->userid }}');$('#model_2_userorg').val('{{ $va->enrollorg }}');">密碼重設</button></td>
                                                    <td class="text-center"><button type="button" class="btn btn-info waves-effect waves-light m-b-5" data-toggle="modal" data-target="#modol_3" onclick="$('#model_3_userid').val('{{ $va->userid }}');$('#model_3_userorg').val('{{ $va->enrollorg }}');">帳號重設</button></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content p-0 b-0">
                <div class="card mb-0">
                        ...
                        {!! Form::open([ 'method'=>'post', 'url'=>'/admin/password_maintenance_user/act1' ]) !!}
                            <div class="card-body">
                                <p class="mb-0">使用狀態：</p>
                            ...
                            <input type="hidden" name="userorg" id="model_1_userorg">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content p-0 b-0">
                <div class="card mb-0">
                    ...
                    <div class="modal-footer py-2">
                        {!! Form::open([ 'method'=>'post', 'url'=>'/admin/password_maintenance_user/act2' ]) !!}
                            <input type="hidden" name="userid" id="model_2_userid">
                            <input type="hidden" name="userorg" id="model_2_userorg">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content p-0 b-0">
                <div class="card mb-0">
                    ...
                    <div class="modal-footer py-2">
                        {!! Form::open([ 'method'=>'post', 'url'=>'/admin/password_maintenance_user/act3' ]) !!}
                            <input type="hidden" name="userid" id="model_3_userid">
                            <input type="hidden" name="userorg" id="model_3_userorg">
