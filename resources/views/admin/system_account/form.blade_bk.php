                ...
                <div class="card">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control input-max" id="idno" name="idno" placeholder="請輸入身分證字號" value="{{ old('idno', (isset($data->idno))? $data->idno : '') }}" autocomplete="off" maxlength="10" required>
                            </div>
                            <!-- 證號別 -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control input-max" id="fname" name="fname" placeholder="請輸入姓氏" value="{{ old('fname', (isset($data->fname))? $data->fname : '') }}" {{ old('fname', (isset($data->fname))? "disabled='disabled'" : '') }} autocomplete="off" maxlength="255" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control input-max" id="lname" name="lname" placeholder="請輸入名字" value="{{ old('lname', (isset($data->cname))? str_replace($data->fname, '', $data->cname) : '') }}" {{ old('cname', (isset($data->cname))? "disabled='disabled'" : '') }} autocomplete="off" maxlength="255" required>
                            </div>
                        </div>
                        ...
                        <!-- 第二類被保險人 -->
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">健保第二類被保險人</label>
                            <div class="col-md-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                               <select id="bankcode" name="bankcode" class="select2 form-control select2-single input-max" placeholder="請選擇銀行代碼" >
								   <?php
										foreach($list as $row):
										 if(isset($data->bankcode) && $data->bankcode==$row->code)
