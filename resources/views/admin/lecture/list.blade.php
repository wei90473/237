    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">講座資料維護</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">講座資料維護列表</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>講座資料維護</h3>
                        </div>
                                        ...
                                        <form method="get" id="search_form">
                                            ...
                                            <div class="float-md mobile-100 row mr-1 mb-3">
                                                ...
                                                <div class="input-group col-4">
                                                    ...
                                                    <input type="text" id="class_name" name="class_name" class="form-control" autocomplete="off" value="{{ $queryData['class_name'] }}">
                                                </div>
                                                <div class="input-group col-4">
                                                    <div class="input-group-prepend">
                                            ...
                                            <div class="float-left">
                                                ...
                                                <!-- 新增班別資料 -->
                                                <a href="/admin/lecture/create">
                                                    <button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0"><i class="fa fa-plus fa-lg pr-2"></i>新增講座資料</button>
                                                </a>
                                                <a href="/admin/lecture/import">
                                                    <button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0">名冊匯入</button>
                                                </a>
                                            </div>
                                        </form>
                                    </div>
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="/admin/lecture/{{ $va->serno }}/edit" data-placement="top" data-toggle="tooltip" data-original-title="修改">
