...
@section('content')
    ...
    <?php $_menu = 'manage_monthly_classroom';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">教室場地管理月報表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">教室場地管理月報表</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="/admin/manage_monthly_classroom/export" id="search_form">
                        {{ csrf_field() }}
