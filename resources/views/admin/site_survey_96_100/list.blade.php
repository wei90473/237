    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">場地問卷及統計表(96~100)</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">場地問卷及統計表(96~100)</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>場地問卷及統計表(96~100)</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="float-left search-float col-12">
                                        <form method="post" id="search_form" action="/admin/site_survey_96_100/export" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                            <div class="card">
                                                        <div class="card-header">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    <?php $sdatetw =''; $edatetw =''; ?>
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2 control-label text-md-right pt-2">擲回日期<span class="text-danger"></span></label>
                                                                        <div class="col-sm-10">
                                                                            <div class="input-group bootstrap-touchspin number_box">
                                                                                <!-- 輸入欄位 -->
                                                                                <input type="text" class="form-control input-max width" value="{{$sdatetw}}" name="sdatetw"  id="sdatetw" placeholder="請選擇要查詢的日期" readonly min="1" autocomplete="off">                                                                                
                                                                            </div>
                                                                        </div>
                                                                    </div>                                                                    
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <div class="input-group bootstrap-touchspin number_box">
                                                                                <!-- 輸入欄位 -->
                                                                                <select class="select2 form-control select2-single input-max" id="yerly" name="yerly" onchange="getTimeBySite();">                                                                                
...
<script>  
    function getTimeBySite()
    {
        $.ajax({
            ...
            dataType: "html",
            url: '/admin/site_survey_96_100/getTimeBySite',
    ...
    function submitSearch() {
        var radiotype = document.querySelector('input[name = radiotype]:checked').value;
            ...
            if((radiotype == "1") && ($("#sdatetw").val() == "" || $("#sdatetw").val() == null || $("#sdatetw").val() == undefined)){
                alert("請輸入擲回日期");
                return;
            }
            else if((radiotype == "2") && ($("#yerly").val() == "" || $("#yerly").val() == null || $("#yerly").val() == undefined)) {
                alert("年度不可空白!請輸入年度");
                return;
            }else {
                if((radiotype == "2") && ($("#times").val() == "" || $("#times").val() == null || $("#times").val() == undefined )) {                    
                    alert("第幾次調查不可空白!請選擇第幾次調查");
                    return;            
                } else {
                    $("#search_form").submit();
                }
