    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">課程配當</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">課程配當</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>課程配當</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="float-left search-float col-12">
                                        <form id="exportFile" method="post" id="search_form" action="/admin/course_assignment/export" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                            <!-- 班別 -->
   ...
   if("<?php echo ($result); ?>" != ""){
    ...
    function getTerms()	{
        $.ajax({
            ...
            dataType: "html",
            url:"/admin/course_assignment/getTerms",
