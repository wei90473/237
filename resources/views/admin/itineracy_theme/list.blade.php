...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>巡迴研習主題</h3>
                        </div>
    ...
    <div class="modal fade" id="CreateModal" role="dialog">
        <div class="panel panel-primary list-panel" id="list-panel">
            <div class="modal-dialog">
                <!-- form start -->
                {!! Form::open([ 'method'=>'POST', 'url'=>'/admin/itineracy_theme/', 'id'=>'form']) !!}
    ...
    <div class="modal fade" id="EditModal" role="dialog">
        <div class="panel panel-primary list-panel" id="list-panel">
            <div class="modal-dialog">
                <!-- form start -->
                {!! Form::open([ 'method'=>'PUT', 'url'=>'/admin/itineracy_theme/999', 'id'=>'form2']) !!}
                <div class="modal-content">
                    <div class="modal-header">
                        <!-- <h4 class="modal-title">新增類別</h4> -->
                    </div>
                ...
                {!! Form::open([ 'method'=>'delete', 'url'=>'/admin/itineracy_theme/999', 'id'=>'deleteform']) !!}
...
<script>
    ...
    function Edit(code) {
        ...
        $("#E_name").val(name);
        $("#D_code").val(code);
        $("#form2").attr('action', 'http://172.16.10.18/admin/itineracy_theme/'+code);
    ...
    function actionDelete(){
        if( $("#D_code").val()!='' && $("#E_name").val()!=''){
            var code = $("#D_code").val();
            $("#deleteform").attr('action', 'http://172.16.10.18/admin/itineracy_theme/'+code);
            $("#deleteform").submit();
        }else{
            alert('請輸入代號名稱 !!');
            return ;
