                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>訓練績效處理</h3>
                        </div>
...
<!-- 進階/簡易搜尋開始 -->                                            
                                            ...
                                            <div class="float-md mobile-100 row mr-1 mb-3">
                                                ...
                                                <!-- 委訓單位 -->
                                                <div class="input-group col-5" id="clientclass" style="display: none;">
                                                    <div class="input-group-prepend">
                                            ...
                                            <!-- <div class="form-group row">
                                                ...
                                                <div class="pt-2">
                                                    <input type="radio" id="select" name="select" value="1" checked>自行建檔
                                                    @if($queryData['select']=='2')
                                                    <input type="radio" id="select" name="select" value="1" >自行建檔
                                                    <input type="radio" id="select" name="select" value="2" checked>電子檔匯入
                                                    @else
                                                    <input type="radio" id="select" name="select" value="1" checked>自行建檔
                                                    <input type="radio" id="select" name="select" value="2" >電子檔匯入
                                                    @endif
                                                </div>
                                            </div> -->
<!-- 進階/簡易搜尋結束 -->
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <!-- 修改 -->
                                                    <td class="text-center">
                                                        <a href="/admin/performance/{{ $va->class.$va->term }}/edit" data-placement="top" data-toggle="tooltip" data-original-title="編輯">
