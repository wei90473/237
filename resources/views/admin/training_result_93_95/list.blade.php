...
@section('content')
    ...
    <?php $_menu = 'training_result_93_95';?>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">訓練成效評估結果統計圖表(93~95)</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">訓練成效評估結果統計圖表(93~95)</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>訓練成效評估結果統計圖表(93~95)</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="float-left search-float col-12">
                                        <form method="post" id="search_form" action="/admin/training_result_93_95/export" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                            <!-- 班別 -->
...
<script>
    ...
    function getTermByClass()
    {
        $.ajax({
            ...
            dataType: "html",
            url: '/admin/training_result_93_95/getTermByClass',
    ...
    function getTimeByClass()
    {
        $.ajax({
            ...
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            dataType: "html",
            url: '/admin/training_result_93_95/getTimeByClass',
            data: {
                class: $('#class').val(),
                term: $('#term').val()
            },
