    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row pc_show">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">各月份費用統計表</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="/admin">首頁</a></li>
                        <li class="active">各月份費用統計表</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="/admin/monthly_money/export" id="search_form">
                        {{ csrf_field() }}
