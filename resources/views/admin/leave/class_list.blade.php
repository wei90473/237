                                ...
                                <div class="col-12">
                                    ...
                                    <div class="float-left search-float" style="margin-bottom: 10px;min-width: 1000px;">
                                        <form method="get" id="search_form">										
                                            ...
                                            <a href="/admin/leave/class_list"><button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0">重設條件</button></a>
                                        </form>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered mb-0">
                                            ...
                                            @foreach($data as $t04tb)
                                                <tr>
                                                    <td><a href="/admin/leave/{{ $t04tb->class }}/{{ $t04tb->term }}"><button class="btn btn-primary btn-sm mb-3 mb-md-0">編輯</button><a/></td>
