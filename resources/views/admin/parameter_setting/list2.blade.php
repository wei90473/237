                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item"><a href="#" class="nav-link active">講座寢室維護</a></li>
                                    ...
                                    <div class="float-left search-float" style="min-width: 1000px;">
                                        ...
                                        <input type="hidden" id="search" name="search" class="form-control" value="search">
                                            ...
                                            <div class="float-md mobile-100 row mr-1 mb-3 ">
                                                <div class="input-group col-6">
                                                     <div class="input-group-prepend">
                                                        <span class="input-group-text">寢室編號</span>
                                                    </div>
                                                    <input type="text" id="room_number" name="room_number" class="form-control" autocomplete="off" value="{{ $queryData['room_number'] }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="float-left">
                                                ...
                                                <!-- 重設條件 -->
                                                <a href="/admin/parameter_setting_2/create">
                                                    <button type="button" class="btn btn-primary btn-sm mb-3 mb-md-0"><i class="fa fa-plus fa-lg pr-2"></i>新增寢室編號</button>
                                                </a>
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="/admin/parameter_setting_2/{{ $va->id }}/edit" data-placement="top" data-toggle="tooltip" data-original-title="修改">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                    </td>
                                                    <td>{{ $va->room_number }}</td>
