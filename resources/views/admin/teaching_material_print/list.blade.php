                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list pr-2"></i>教材交印資料處理</h3>
                        </div>
                                            ...
                                            @foreach($data as $va)
                                                ...
                                                <!-- 修改 -->
                                                    <td class="text-center">
                                                        <a href="/admin/teaching_material_print/list/{{ $va->class.$va->term }}" data-placement="top" data-toggle="tooltip" data-original-title="編輯">
